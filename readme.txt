...
Yes, there are lots of Google Maps WordPress Plugins out there, but none of these fulfilled my needs…in a nutshell, geoblogging made trivial. Every post can have an address, and can generate a google map. Generate a global map with all the mapped posts and place this in a page. And then…filter the global map by category.
