...
Yes, there are lots of Google Maps WordPress Plugins out there, but none of these fulfilled my needs - in a nutshell,  make  geoblogging trivial. Follow me. In every post you just need to enter an address, in a custom box, and then the plugin will automatically insert in the post a Google Map with the single post's address. The plugin can build also a global map with more posts mapped together, by category too. A very useful tool for adding a browsable map of all your posts to your site. Can be ideal for mapping itineraries or building a travel website, or a destination guide.  
