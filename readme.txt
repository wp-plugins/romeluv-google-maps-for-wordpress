...
*    Generating a Global Map with all the posts, placing this global map in a standard WordPress Page via a simple [GLOBALMAP] shortcode.
*    Global Map Live example: http://www.romeluv.com/map
*    Filtering the Global Map adding just a category parameter to the URL, just add the parameter like shown above to your page’s URL, where you’ve placed the global map shorttag.
